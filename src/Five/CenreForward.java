 ...
 * PROGRAM DESCRIPTION:
 * <p>
 * This Program is used to create the CenreForward Object. It has attributes,
...
//A CenreForward is a Forward that in addition has the following: longBallsRecieved (X: int type)
public class  CenreForward extends Forward {
	 ...
	 * @param longBallsRecieved  The number of long balls recieved by the CenreForward object.
	 */
	public CenreForward (String name, Date dob, String clubName, String countryName, int numYellowCards,int numRedCards,
			             int gamesPlayed, int goalsScored, int numAssists, int shotsOnTarget, int longBallsRecieved ) {
	 ...
	 */
	public CenreForward (CenreForward c) {
		this.longBallsRecieved = c.longBallsRecieved;
	}
	 ...
	 * @return An integer value of the longBallsRecieved attribute.
	 */
	 ...
	 * @param longBallsRecieved       It sets the variable with a value. 
	 */
	...
	public String toString () {
		return  ("\nName: "                 + this.getName()
				...
				+"\nnGoals Scored: "         + this.getGoalsScored()
		        +"\nGoals Assisted: "       + this.getNumAssists ()
		        +"\nGoals Shot on Target: " + this.getShotsOnTarget ()
		        +"\nLong Balls Recieved: "  + this.getLongBallsRecieved()
				+"\nCautions:"
	...
	public  boolean equals(Object obj) {
      ...
      try {  
	        final CenreForward other = (CenreForward) obj;
	        ...
	        //new
		        if (this.longBallsRecieved != other.longBallsRecieved) {
		        	return false;
		        }
